...
/* Exception Table */
__attribute__((section(".vectors"))) const struct {
    DeviceVectors exception_table;
    uint32_t single_reset_magic;
...
#endif
#endif
    }, .single_reset_magic = 0x87eeb07c /* this will request the bootloader to be activated with SINGLE_RESET */ };
